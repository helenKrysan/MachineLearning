...
namespace MachineWPF.Practice2
{
    class TestModelPractice2
    {
        ...
        public TestModelPractice2(bool isRandom)
        {
            SetValues(isRandom, new Point(10, 10), new Point(5, 5), 5, 6);
        }

        public TestModelPractice2(bool isRandom, Point maxXY, Point minXY)
        {
            SetValues(isRandom, maxXY, minXY, 5, 6);
        }

        public TestModelPractice2(bool isRandom, int partsX, int partsY)
        {
            SetValues(isRandom, new Point(10, 10), new Point(5, 5), partsX, partsY);
        }

        public TestModelPractice2(bool isRandom, Point maxXY, Point minXY, int partsX, int partsY)
        {
            SetValues(isRandom, maxXY, minXY, partsX, partsY);
        }

        private void SetValues(bool isRandom, Point maxXY, Point minXY, int partsX, int partsY)
        {
